...
<br>
<div
	style="border: 2px solid #dee2e6; width: 80%; margin: auto; height: 350px;">
	<div class="form-group row">
		<div class="col-3">
			<img src="/image/${result.bPic1}" class="d-block w-100" alt="..."
				id="design" style="margin-top: 50px;">
		</div>
		<div class="col-3" style="margin-top: 120px;">
			<h5>
				<b>제목:</b>&nbsp;&nbsp;${result.bTitle}
			</h5>
			<br>
			<h5>
				<b>작성자:</b>&nbsp;&nbsp;${result.uId}
		...
		<div class="col-3" style="margin-top: 140px;">
			<h5>
				<b style="font-size: xx-large; color: #007bff;">결제금액:&nbsp;&nbsp;${result.bPrice}
					&nbsp;원</b>
			</h5>
			<br>
		</div>
		<div class="col-3" style="margin-top: 120px;">
			<h5>
				<b>현재 포인트 :</b>&nbsp;&nbsp;${point.rPoint} &nbsp;원
			</h5>
			<br>
			<h5>
				<b>구매 후 포인트 :</b>&nbsp;&nbsp;${point.rPoint - result.bPrice} &nbsp;원
			</h5>
		</div>
	</div>
</div>
<script>
	$(function() {
		$("#payMsg").click(function() {
			location.href = 'userBuy.do?b_num=' + $
			{
				result.bNum
			}
			+'&buyPrice=' + $
