				...
				<div id="carouselExampleControls" class="carousel slide"
					...
					<div class="carousel-inner">
						<div class="carousel-item active">
							<img src="/image/${result.bPic1}" class="d-block w-100" alt="..."
								style="max-width: 800px; height: 400px;">
						</div>
						<div class="carousel-item">
							<img src="/image/${result.bPic2}" class="d-block w-100" alt="..."
								style="max-width: 800px; height: 400px;">
						</div>
						<div class="carousel-item">
							<img src="/image/${result.bPic3}" class="d-block w-100" alt="..."
								style="max-width: 800px; height: 400px;">
						</div>
					</div>
			...
			<div class="col-5">
				<div class="card">
					<div class="card-body">
						...
						<div class="row">
							<div class="col-md-5">
								<h3 style="font-weight: bold;">[${result.bCate}]</h3>
							</div>
							<div class="col-md-7">
								<h3>${result.bTitle}</h3>
							</div>
								...
								<table>
									<tr>
										...
										<td><input type="text" name="sId" id="sId"
											class="s_form s_form-input" value="${result.uId}"
									...
									<tr>
										<td><textarea name="mContent" id="mContent"
												...
												style="border-radius: 6px; border: solid 1px #e5e5e5; width: 460px; height: 200px;"></textarea></td>
									</tr>
								</table>
								<br> <input type="hidden" name="uId" id="uId"
									class="s_form s_form-input" />
								<button type="submit" id="submit" name="submit"
									onclick="sendMsg();" class="s_form-btn semibold"
       ...
       // 정상적으로 검색이 완료됐으면 
		...
		<section class="design-process-section" id="process-tab">
			<div class="container">
				<div class="row">
					<div class="col-12">
						<ul class="process-model more-icon-preocess " role="tablist"
							...
							<c:forEach var="i" begin="0" end="${result.bDay2-1}">
								<li role="presentation" class="active"><a href="#discover"
									aria-controls="discover" role="tab" data-toggle="tab"><i
										id="bb${i}" aria-hidden="true" onclick="show_hide(${i})">${i+1}일차</i></a></li>
							</c:forEach>
						</ul>
						<!-- 'display', '' -->
						<script type="text/javascript">
								...
								<c:forEach items="${results}" var="results" varStatus="status">
									<c:forEach var="i" begin="0" end="${result.bDay2}">
										<c:if test="${status.index eq i}">
											<div role="tabpanel" class="tab-pane" id="strategy${i}"
												style="display: none;">
												<h3 class="semi-bold" style="margin-top: 30px;">${i+1}일차
													&nbsp; (주소: ${results.bPost})</h3>
												...
												<div class="form-group row" style="text-align: center;">
													<div class="col-sm-3">
														...
														<h5>
															<label for="b_trav" class="col-form-label">여행비</label>
														</h5>
													</div>
													<div class="col-sm-3">
														<img src="images/food.png" style="max-width: 30%;">
														<h5>
															<label for="b_food" class="col-form-label">식비</label>
														</h5>
													</div>
													<div class="col-sm-3">
														<img src="images/trans.png" style="max-width: 30%;">
														<h5>
															<label for="b_trans" class="col-form-label">교통비</label>
														</h5>
													</div>
													<div class="col-sm-3">
														<img src="images/stay.png" style="max-width: 30%;">
														<h5>
															<label for="b_stay" class="col-form-label">숙박비</label>
														</h5>
													</div>
												</div>
												<div class="form-group row" style="text-align: center;">
													<div class="col-sm-3">
														<h2>${results.bTrav}원</h2>
													</div>
													<div class="col-sm-3">
														<h2>${results.bFood}원</h2>
													</div>
													<div class="col-sm-3">
														<h2>${results.bTrans}원</h2>
													</div>
													<div class="col-sm-3">
														<h2>${results.bStay}원</h2>
													</div>
													<br>
													<br>
													<br>
		...
		<div class="row butt1">
			<div class="col-md-6" style="margin-left: 65px;">
				<c:if test="${result.uId == sessionScope.u_id}">
					<button id="br" class="butt" style="float: center; padding: 0.7em;"
						onclick="del()">삭제</button>
					<button id="br" class="butt" style="float: center; padding: 0.7em;"
						onclick="location.href = 'updateForm.do?b_num=${param.b_num}'">수정</button>
				</c:if>
				<button id="br" class="butt" style="float: center; padding: 0.7em;"
					onclick="location.href = 'detail.do?&lotation=&day=&trans=&cost=&tema=&search='">목록</button>
			</div>
		</div>
	</div>
	<br><br><hr><br>
